...
<div className='w-[300px]  lg:w-[680px] border-[1px] border-[rgba(0, 0, 0, 0.10)] h-[429px] lg:h-[520px] bg-[#F8F8F8] mt-4 rounded-md mr-2'>
  ...
  <img src={bannerImg} className=' rounded-lg mt-[20px] h-auto lg:h-[329px] w-[300px] lg:w-[650px] mx-[5px] lg:mx-[20px] '></img>
...
<img src={editImg} className=' lg:justify-end'></img>
          ...
          <div className='flex flex-col lg:flex-row mt-[10px] justify-between w-[400px] lg:w-[600px] '>
              {/* comments */}
...
<p className='text-[14px] font-normal text-[#636363]'> 120 Comments</p>
              ...
              {/* liked */}
              <div className='flex -mt-5 lg:-mt-0 mr-[50px]  justify-center '>
                  <img src={heartImg}  className='mr-1'></img>
...
<p className='text-[14px] font-medium text-[#636363] justify-end'>10 minute read</p>
 ...
 {/* second post */}
 <div className='bg-[#F8F8F8] w-[300px]  lg:w-[680px]  border-[1px] border-[rgba(0, 0, 0, 0.10)]  h-[224px] mt-[50px] lg:mt-[30px] rounded-lg mr-2'>
...
//  responsive
 {/* second post */}
 <div className='bg-[#F8F8F8]  border-[1px] border-[rgba(0, 0, 0, 0.10)]  h-[224px] mt-[50px] lg:mt-[30px] rounded-lg mr-2'>
 <div className='flex my-[30px] mx-[10px] my-2'>
     {/* image */}
     <img src={postImg}  className='w-[41px] h-[41px] rounded-full'></img>
     <div className='ml-2'>
         {/* details */}
         <div className='flex justify-between  w-[330px] lg:w-[600px]'>
<div className='flex justify-start'>

         <h2 className='text-[20px] font-semibold '>Shiblu Ahmad</h2>
         <svg xmlns="http://www.w3.org/2000/svg" width="4" height="4" viewBox="0 0 4 4" fill="none" className='mt-4 mx-1' >
<circle cx="2" cy="2" r="2" fill="black" fillOpacity="0.7"/>
</svg>
<p className='text-[12px] font-normal text-[#00000099] mt-2'>10 hours ago</p>
...
<img src={editImg} className='justify-end'></img>
         </div>
         <p className='text-[14px] font-normal text-[#00000099]'>Sunday, Dec 12, 07:10 AM</p>
         <h2 className='text-[15px] lg:text-[20px] mt-[15px] font-medium text-[#000000CC]'>Successful marriage from our biyekorun app</h2>
         <div className='flex '>
             <p className='text-[14px] font-normal text-[#F42A41] mr-[20px]'>#engagement</p>
             <p className='text-[14px] font-normal text-[#F42A41] mr-[20px]'>#wedding</p>
             <p className='text-[14px] font-normal text-[#F42A41] mr-[20px]'>#marriage</p>
         ...
         <div className='flex flex-col lg:flex-row mt-[10px] justify-between w-[600px]'>
             {/* comments */}
             <div className='flex mr-[50px] justify-start'>
             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"  className='mr-1'>
<g clipPath="url(#clip0_1692_7126)">
...
<img src={editImg} className='justify-end'></img>
         ...
         <p className='text-[14px] mb-[15px] font-normal text-[#00000099]'>Sunday, Dec 12, 07:10 AM</p>
         <h2 className='text-[15px] lg:text-[20px]font-medium text-[#000000CC]'>Successful marriage from our biyekorun app</h2>
         <div className='flex '>
             <p className='text-[14px] font-normal text-[#F42A41] mr-[20px]'>#engagement</p>
             <p className='text-[14px] font-normal text-[#F42A41] mr-[20px]'>#wedding</p>
             <p className='text-[14px] font-normal text-[#F42A41] mr-[20px]'>#marriage</p>
